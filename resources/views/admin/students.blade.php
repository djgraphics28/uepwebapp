    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered table-hover datatable" id="students_tbl" width="100%">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
        ...
        <div class="modal fade" id="modal-station" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <form id="add_station" method="POST" action="{{ url('/save-student') }}" enctype="multipart/form-data">
                        @csrf
...
<script>
    $(document).ready(function(){
        ...
        $('#datepicker').datepicker({
         ...
         /* Delete Button */
        $('#students_tbl').on('click', '#btn-del', function(){
            $.ajax({
         ...
         /* View Button */
        $('#students_tbl').on('click', '#btn-view', function(){
